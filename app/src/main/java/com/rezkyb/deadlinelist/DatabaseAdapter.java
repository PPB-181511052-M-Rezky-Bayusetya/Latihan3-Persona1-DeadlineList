...
public class DatabaseAdapter {
    ...
    static final String KEY_NAME = "deadline_name";
    static final String KEY_DETAILS = "deadline_detail";
    static final String KEY_DATE = "deadline_date";
    static final int DATABASE_VERSION = 2;
    static final String DB_NAME="deadlineDB";
    static final String DB_TABLE="deadline";
    static final String TAG = "DatabaseAdapter";
    static final String DATABASE_CREATE = "create table deadline(_id integer primary key autoincrement," + "deadline_name text not null, deadline_detail text, deadline_date text);";
